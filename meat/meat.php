...
switch($_GET["action"]) {
  case "add":
    if(!empty($_POST["quantity"])) {
      $productByCode = $db_handle->runQuery("SELECT * FROM productmeat WHERE code='" . $_GET["code"] . "'");
      $itemArray = array($productByCode[0]["code"]=>array('name'=>$productByCode[0]["name"], 'code'=>$productByCode[0]["code"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode[0]["price"], 'img_path'=>'Meat/'.$_POST["img_path"]));
...
<br><br><br>
  <div class="txt-heading" style="text-align:left;color:#d5d5d5;"><a href="../index2.php" style="text-decoration:none;color:#33B6CB;margin-left:120px;">Home/</a> Products/ <a href="meat.php" style="color:#33B6CB;text-decoration: none;">meat</a></div>
 ...
 <div class="container-fluid" style="width:90%;">
  <div class="row">
    <div class="col-sm-2" style="background-color:#e3e3e3;color:#428bca;">
              ...
              <ul>
                <li class=""><a href="../fruits/fruitss.php">fruits</a></li>
                <li><a href="meat.php">meat</a></li>
                <li><a href="../discount_product/discount_product.php">discount_product</a></li>
  ...
  ?>
    <div class="product-item" style="background:#fff;">
      <form method="post" action="meat.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
        <input type="hidden" name="img_path" value="meatproduct/<?php echo $product_array[$key]["image"]; ?>">
      <div class="product-image"><img style="max-height: 250px;max-width: 250px;" src="meatproduct/<?php echo $product_array[$key]["image"]; ?>"></div>

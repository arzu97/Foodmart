...
if (isset($_POST['register'])) {
  ...
  if ($saved) {
    header('location:signup.php?status=error&msg= successfully registered!');
  }
}
 ?>
...
<html>
<head>
	<title>Foodmart-Registration-Form</title>
    ...
    <div class="col-sm-5" style="float:left;margin-top:0px; margin-left: 100px;">
      <div class="panel panel-default text-center">
        <div class="panel-heading">
          <a href="../index.php"><h3 style="color: #fff;">Foodmart.com</h3></a>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
             ...
             <input  type="password" class="form-control" id="usr" minlength="8" placeholder="password" name="password" required="">
               </div><br><br>

...
<head>
  ...
  <title>Foodmart.com.Com-Index</title>
  <meta charset="utf-8">
    ...
    <div class="col-sm-9" style="background-color:#e3e3e3;margin-left:10px;">
      <p>Sed ut perspiciatis...</p>
          ...
          <tr>
            ...
            <td><img src="../fruits/fruitsproduct/<?php echo $row ['image']?>" style="height: 100px;width: 100px;"></td>
            <td class="center">
              ...
              <?php include('fruitssproductdelete.php'); ?>
            </td>
          </tr>
              <?php } ?>
          </tbody>

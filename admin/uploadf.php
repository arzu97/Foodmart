...
<style type="text/css">
	...
	<div class="col-md-6 well" style="margin-top:80px;background-color:#ffffff;border:360px;">
		<h3 class="text-primary" style="text-align:center;">Foodmart.com-Upload-Product-Form</h3><br>
		<a href="meatproduct.php">Back</a>
		...
		<div>
			<form role="form" method="POST" action="upload.php" enctype="multipart/form-data" ><br>
				...
				<input type="text"  class="form-control" name="name" style="width:50%;" required="" placeholder="eg:- butter,sausage" /><br>
				<label>Type:</label>
				<input type="text"  class="form-control" name="code" style="width:50%;" required="" placeholder="eg:- chicken,cheese_sauce,ramen" /><br>
				<label>Price:</label>

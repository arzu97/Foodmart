...
echo "<script>alert('Successfully Updated User Info!'); window.location='fruits.php'</script>";
}
...
?>
  ...
  ?>
    <div class="product-item" style="background:#fff;">
      ...
      <div class="product-image"><img src="fruitsproduct/<?php echo $product_array[$key]["image"]; ?>"></div>

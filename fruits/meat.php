...
<html>
<head>
  <title>Foodmart.Com-Men's</title>
  <meta charset="utf-8">
 ...
 <div class="container-fluid" style="width:90%;">
  <div class="row">
    <div class="col-sm-2" style="background-color:#e3e3e3;color:#428bca;">
              ...
              <ul>
                ...
                <li><a href="../meat/Meat.php">Meat's</a></li>
  ...
  ?>
    <div class="product-item" style="background:#fff;">
      ...
      <div class="product-image"><img style="max-height: 250px;max-width: 250px;" src="fruitsproduct/<?php echo $product_array[$key]["image"]; ?>"></div>

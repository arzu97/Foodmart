...
<style type="text/css">
	...
	<div class="col-md-6 well" style="margin-top:80px;background-color:#ffffff;border:360px;">
		<h3 class="text-primary" style="text-align:center;">Foodmart.com-Upload-Product-Form</h3>
		<a href="discount_product.php">back</a>
		...
		<div>
			<form role="form" method="POST" action="uploadera.php" enctype="multipart/form-data" ><br>
				...
				<input type="text"  class="form-control" name="name" style="width:50%;" required="" placeholder="eg:- orange,carrot," /><br>
				<label>Type:</label>
				<input type="text"  class="form-control" name="code" style="width:50%;" required="" placeholder="eg:- banana, baby corn, pomegranate" /><br>
				<label>Price:</label>
				<input type="text" class="form-control" name="price" style="width:50%;" required="" placeholder="eg:-200.00,200.60"><br>
				<label>MadeIN:</label>
				<input type="text" class="form-control" name="madein" style="width:50%;" required="" placeholder="eg:-Dhaka,bangladesh"><br>
